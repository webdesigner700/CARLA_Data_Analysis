...
green_channel = image_array[:,:,0].flatten()
blue_channel = image_array[:,:,0].flatten()
...
print("Red Channel Standard Deviation:", red_std)
print("Green Channel Standard Deviation:", green_std)
print("Blue Channel Standard Deviation:", blue_std)
